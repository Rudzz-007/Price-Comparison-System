...
function App() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      // 1. Fetch live aggregated search results from backend port 8000
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans p-6 transition-colors duration-300">
      {/* Header Layout */}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-5 border border-purple-100 space-y-3 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  {(!analytics?.platform_breakdown || analytics.platform_breakdown.length === 0) && (
                    <div className="text-xs text-slate-400 italic text-center py-2">
                      Insufficient historical dataset parameters.
                    </div>
                  )}
                </div>
              </div>
